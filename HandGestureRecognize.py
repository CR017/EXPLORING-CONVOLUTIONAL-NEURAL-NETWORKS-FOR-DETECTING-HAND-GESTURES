...
main = tkinter.Tk()
main.title("EXPLORING CONVOLUTIONAL NEURAL NETWORKS FOR DETECTING HANDGESTURES")
...
font = ('times', 16, 'bold')
title = Label(main, text='EXPLORING CONVOLUTIONAL NEURAL NETWORKS FOR DETECTING HANDGESTURES',anchor=W, justify=CENTER)
